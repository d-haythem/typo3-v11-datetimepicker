...
namespace Daoued\Typo3Datetimepicker\XClass\Backend\FormElement;
 ...
 */
class InputDateTimeElement extends \TYPO3\CMS\Backend\Form\Element\InputDateTimeElement
{
    /**
    ...
    public function render()
    {
        ...
        $resultArray['requireJsModules'][] = JavaScriptModuleInstruction::forRequireJS(
            'TYPO3/CMS/Typo3Datetimepicker/Backend/FormElement/InputDateTimeElement'
        )->instance($fieldId);
